...
<html>
    ...
    <body> 
        ...
        // Connexion unique à la base de donnée
        $_bdd = null;
                ...
                <ul class="nav navbar-nav">
                    ...
                    if (isLogin()) {
                        ...
                        if (isset($fct) && ($fct == 'tracks' || $fct == 'playlistShow')) {
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th-list"></span> Playlists<span class="caret"></span></a>';
                        } elseif (isset($fct) && $fct == 'playlistAll') {
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th-list"></span> Toutes les playlists<span class="caret"></span></a>';
                        } else {
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-list-alt"></span> Vos playlists<span class="caret"></span></a>';
                        }
                        ...
                        if ((isset($playlistId) && isset($playlist))) {
                            ...
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-folder-open"></span> ' . $playlist->getName() . '<span class="caret"></span></a>';
                            echo '<ul class="dropdown-menu">
                        ...
                        if (isset($fct) && $fct == 'tracks') {
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-music"></span> Tous les titres<span class="caret"></span></a>';
                        } else {
                            echo '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-music"></span> Titres<span class="caret"></span></a>';
                        }
