<div id="<?php echo $modal->getId() ?>Modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" name="<?php echo $modal->getId() ?>" action="<?php echo $modal->getAction() ?>" method="post">
            ...
            <div class="modal-footer">
                <button type="button" name="<?php echo $modal->getId() ?>" class="btn btn-danger" data-dismiss="modal">Annuler</button>
            </div>
        </div>
